...
class BasicCurveLineAreaChart extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (chartObject && chartObject[this.props.chartId]) {
            ...
            chartObject[this.props.chartId].updateBrush(2, {
                type : "scatter",
                target : chartInfo.targets,
                hide : false
            });
    ...
    graphUse = () => {
        graph.use(CustomTheme, LineBrush, AreaBrush, ScatterBrush, TooltipWidget, LegendWidget);
    };
...
export default BasicCurveLineAreaChart;
