...
import ColumnBrush from "juijs-chart/src/brush/stackcolumn";
...
class ActiveStackedColumnChart extends React.Component {
    ...
    componentDidMount = () => {
        ...
        this.graphReady(this.props.chartId, chartInfo.chartDatas, chartInfo.targets, 
                        this.props.legend, this.props.yFormat, this.props.clickCallback, 
    ...
    graphUse = () => {
        graph.use(CustomTheme, ColumnBrush, LegendWidget, TooltipWidget);
    };

    graphReady = (idChart, datas, targets, legend, yFormat, clickCallback, 
...
export default ActiveStackedColumnChart;
